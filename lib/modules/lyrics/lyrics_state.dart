...
class LyricsState extends Equatable {
  const LyricsState(this.lyrics, this.mediaItem);
  ...
  LyricsState copyWith({Lyrics? lyrics, MediaItemModel? mediaItem}) {
    return LyricsState(lyrics ?? this.lyrics, mediaItem ?? this.mediaItem);
  }
}
