...
class SpotifyApi {
  ...
  Future<List<Map>> getFeaturedPlaylists(
    ...
    try {
      ...
      log(
        'Error in getting spotify featured playlists: $e',
        name: "spotifyAPI",
      );
      return List.empty();
    }
  ...
  Future<List<Map>> get50AlbumTracks(
    String accessToken,
    String albumId, {
    int offset = 0,
    int limit = 50,
  ...
  Future<Map<String, Object>> getAllAlbumTracks(
    ...
    try {
      ...
      String? description;
      String? artists;
      final Uri path = Uri.parse('$spotifyApiBaseUrl/albums/$albumId');
      final response = await get(
        path,
        headers: {
          'Authorization': 'Bearer $accessToken',
