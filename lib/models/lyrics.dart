...
enum LyricsProvider { lrcnet, none }
...
class LyricsSearchResults {
  ...
  LyricsSearchResults({this.lyrics, required this.query});
}
...
class ParsedLyric {
  ...
  ParsedLyric({required this.text, required this.start});
...
class ParsedLyrics {
  ...
  ParsedLyrics({required this.syncedLyrics, required this.duration}) {
