...
Image loadImage(
  coverImageUrl, {
  placeholderPath = "assets/icons/logo_img.png",
}) {
...
CachedNetworkImage loadImageCached(
  ...
  return CachedNetworkImage(
    ...
    errorWidget: (context, url, error) => Image(image: placeHolder, fit: fit),
...
class LoadImageCached extends StatefulWidget {
  ...
  const LoadImageCached({
    ...
    this.placeholderUrl = "assets/icons/logo_img.png",
...
Future<ImageProvider> getImageProvider(
  String imageUrl, {
  String placeholderUrl = "assets/icons/logo_img.png",
}) async {
  if (imageUrl != "") {
